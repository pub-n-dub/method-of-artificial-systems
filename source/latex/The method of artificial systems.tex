...
of behavior, to establish a paradigmatic set of discretionary limits,
...
\begin{figure}[H]
\includegraphics[scale=0.5]{figures/cognitionHierarchy}
...
\begin{figure}[H]
\includegraphics[scale=0.5]{figures/entropicCircuit}
...
\begin{figure}[H]
\includegraphics[scale=0.5]{figures/MIT-Witricity}
...
\begin{figure}[H]
\includegraphics[scale=0.5]{figures/model-f}
...
\begin{figure}[H]
\includegraphics[scale=0.5]{figures/cybieInstalled}
...
more privy to a statistical definition delineated by Schrödinger than
...
\begin{figure}[H]
\includegraphics[scale=0.4]{figures/tableOne}
